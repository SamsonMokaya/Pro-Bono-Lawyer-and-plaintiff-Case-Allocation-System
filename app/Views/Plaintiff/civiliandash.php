		...
		<?php if(session()->get('successr')): ?>
			...
			<div class="col-md-12 col-sm-1">
					...
					<div class="col-md-4 col-sm-4">
						<input name="profile" type="submit"  class="form-control" onclick="location.href='<?= base_url('/profile'.'/'.session()->get('ID')) ?>'" id="profile" value="profile">
						<input name="pending" type="submit" class="form-control" onclick="location.href='<?= base_url('/lawyers') ?>'" id="pending"  value="View Our lawyers">
